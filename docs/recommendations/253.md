# _2.5.3 Ensure hidden file serving is disabled _
...
Blocking all dot-files will break Let's Encrypt / Certbot validation (.well-known/acmechallenge) unless explicitly allowed. Ensure the exception rule is placed **before** the deny rule or is more specific.
