# _2.5.4 Ensure the NGINX reverse proxy does not enable information disclosure (Manual)_
...
- 1. [https://nginx.org/en/docs/http/ngx\\\_http\\\_proxy\\\_module.html](https://nginx.org/en/docs/http/ngx_http_proxy_module.html)
- 2. [https://nginx.org/en/docs/http/ngx\\\_http\\\_proxy\\\_module.html#proxy\\\_hide\\\_header](https://nginx.org/en/docs/http/ngx_http_proxy_module.html#proxy_hide_header)
