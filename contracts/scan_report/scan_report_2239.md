# Scanner Report - Port 2239

```text
[Scanner] ✅ Scan result saved to: tmp/contracts/scan_result/scan_result_2239.json
...
[Scanner] 📊 Compliance Score: 17%
[Scanner] 📋 Total: 12 | ✅ Pass: 2 | ❌ Fail: 10
```
