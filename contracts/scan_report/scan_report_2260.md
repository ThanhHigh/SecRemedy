# Scanner Report - Port 2260

```text
[Scanner] ✅ Scan result saved to: tmp/contracts/scan_result/scan_result_2260.json
...
[Scanner] 📊 Compliance Score: 75%
[Scanner] 📋 Total: 12 | ✅ Pass: 9 | ❌ Fail: 3
```
