# Scanner Report - Port 2252

```text
[Scanner] ✅ Scan result saved to: tmp/contracts/scan_result/scan_result_2252.json
...
[Scanner] 📊 Compliance Score: 50%
[Scanner] 📋 Total: 12 | ✅ Pass: 6 | ❌ Fail: 6
```
