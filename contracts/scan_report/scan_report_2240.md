# Scanner Report - Port 2240

```text
[Scanner] ✅ Scan result saved to: tmp/contracts/scan_result/scan_result_2240.json
...
[Scanner] 📊 Compliance Score: 83%
[Scanner] 📋 Total: 12 | ✅ Pass: 10 | ❌ Fail: 2
```
